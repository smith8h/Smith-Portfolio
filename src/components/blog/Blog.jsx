            ...
            <div className="blog__container grid">
                <div className="blog__card">
                    <div className="blog__thumb">
                        ...
                        <a href="https://t.me/smithdev/291"><img src={Blog1} alt="Avatar" className="blog__img" /></a>
                    </div>
                ...
                <div className="blog__card">
                    <div className="blog__thumb">
                        <span className="blog__category">Dependencies</span>
                        <a href="https://t.me/smithdev/285" target="__blank"><img src={Blog1} alt="Avatar" className="blog__img" /></a>
                    </div>
                    <div className="blog__details">
                ...
                <div className="blog__card">
                    <div className="blog__thumb">
                        <span className="blog__category">Dependencies</span>
                        <a href="https://t.me/smithdev/282"><img src={Blog1} alt="Avatar" className="blog__img" /></a>
                    </div>
                    <div className="blog__details">
